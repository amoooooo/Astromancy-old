...
import coffee.amo.astromancy.core.systems.aspecti.AspectiItemCapability;
import coffee.amo.astromancy.core.systems.aspecti.IAspectiHandlerItem;
import coffee.amo.astromancy.core.systems.aspecti.ItemAspectiNonConsumableContainer;
...
public class AspectiPhial extends ItemAspectiNonConsumableContainer {
    public AspectiPhial(Properties pProperties) {
        super(pProperties, new ItemStack(ItemRegistry.ASPECTI_PHIAL.get()), 256);
    }
    ...
    public @Nullable ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag nbt) {
        return new AspectiItemCapability(stack, 256);
    }
}
