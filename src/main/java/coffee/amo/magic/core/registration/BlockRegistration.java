...
import coffee.amo.magic.common.block.ArmillarySphere;
import coffee.amo.magic.common.blockentity.ArmillarySphereBlockEntity;
import coffee.amo.magic.core.setup.content.item.tabs.ContentTab;
...
import static coffee.amo.magic.core.registration.BlockPropertyRegistration.MAGIC_PROPERTIES;

public class BlockRegistration {
    private static final Registrate REGISTRATE = Magic.registrate().creativeModeTab(ContentTab::get);
