...
public class TabRegistry {
    ...
    public static void doSetup() {
        INTRODUCTION.get().addChildren(ResearchRegistry.INTRODUCTION.get(), ResearchRegistry.STELLARITE.get(), ResearchRegistry.CRUCIBLE.get(), ResearchRegistry.ALCHEMICAL_BRASS.get(), ResearchRegistry.ARCANA_SEQUENCE.get(), ResearchRegistry.ARMILLARY_SPHERE.get(), ResearchRegistry.STELLAR_OBSERVATORY.get(), ResearchRegistry.TEST_1.get());
